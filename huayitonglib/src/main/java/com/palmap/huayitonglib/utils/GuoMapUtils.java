...
//                ,PropertyFactory.textAllowOverlap(Function.property("allowShow", new IdentityStops<Boolean>()))
//                ,PropertyFactory.textAllowOverlap(new CameraFunction<"allowShow", Boolean>)
