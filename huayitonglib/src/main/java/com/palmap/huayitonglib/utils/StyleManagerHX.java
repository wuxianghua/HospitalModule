...
public class StyleManagerHX {
    ...
    public StyleManagerHX(int... poiIds) {
    ...
    public void attach(FeatureCollection featureCollection) {
        ...
        for (Feature feature : features) {
            ...
            feature.addProperty(NAME_COLOR, new JsonPrimitive(MapConfig2.DEFAULT_COLOR));
            feature.addProperty(NAME_BORDER_COLOR, new JsonPrimitive(MapConfig2.DEFAULT_COLOR_BORDER));
